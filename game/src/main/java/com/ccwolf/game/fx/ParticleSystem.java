...
public final class ParticleSystem {
    ...
    public void draw(Surface surface, Camera camera) {
        ...
        drawPass(surface, camera, true);
        drawPass(surface, camera, false);
    }

    private void drawPass(Surface surface, Camera camera, boolean background) {
        ...
        for (int i = 0; i < CAPACITY; i++) {
            ...
            surface.fillRect(screenX - half, screenY - half, screenX + half, screenY + half,
                    paint);
        }
    }

...
public final class FxDirector {
    ...
    public void drawDecals(Surface surface, Camera camera) {
        decals.draw(surface, camera);
    }

    /** Rounds and particles, drawn over the entities. */
    public void drawOverlay(Surface surface, Camera camera) {
        projectiles.draw(surface, camera);
